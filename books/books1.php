...
<body class="">
  <div class="wrapper ">
    ...
    <div class="main-panel">
     ...
     <a href='edit.php?edit=<?php echo $row['id']; ?>' style='text-decoration:none'><button class="btn btn-primary" style="width: 60px;padding: 5px;margin-top: 15px;"><i class="fa fa-edit "></i> Edit</button></a>
