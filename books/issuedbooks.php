    ...
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line" style = 'font-size:25px; font-weight:bolder;border-bottom:2px solid black;'>Manage Issued Books</h4>
    </div>
    <br><br> <br><br>
...
<?php 
                    ...
                    include 'conf.php';
                    $stmt = $db->prepare("select * from tblissuedbookdetails");
                    $stmt->execute();
                    $cnt=1;
                    if($stmt->rowCount() > 0)
                    {
                    ...
                    {           ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="up_issue_book.php?rid=<?php echo $row['id'];?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
