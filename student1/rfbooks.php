    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-7 col-sm-offset col-md-10 col-md-offset main">
		  ...
		  <h1 class="page-header">Request For A Book</h1>
      <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
        <div class="s1">
		    <form action="request.php" method="post">
                        <div class="input-field">
                            <input type="text" value="<?php echo $users['name'] ?>"  name="stuname" readonly>
                            <label>Student Name</label>
                        </div>
                         <div class="input-field">
                            <input type="text"  value="<?php echo $users['rollno'] ?>"  name="sturoll"  readonly>
                        ...
                        <input type="submit" name="send" value="Request" class="btn">
