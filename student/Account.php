                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                ...
                                <li>
                                    <a href="forget-pass.html">Select Password</a>
                                </li>
                            </ul>
                        </li>
...
if($row['image']=="")
      {
      ?>
            <img style=" width: 200px;height: 200px;" src="../images/person.jpg" alt="not found"/>
      <?php 
      }
      else
      {
      ?>
  <img style=" width: 200px;height: 200px;" src="../images/<?php echo $row['image'];?>" alt="not found"/><?php } ?>
</div>
<div class="form-group" style="">
