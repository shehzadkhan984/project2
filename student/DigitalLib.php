...
<head>
    ...
    <!-- Title Page-->
    <title>LMS | DIGITAL LIBRARY</title>
                    ...
                    <div class="container-fluid">
                         <div class="row m-t-30">
                            <div class="col-md-12">
                                ...
                                <h2 class="title-1 m-b-25">DIGITAL LIBRARY</h2>
                                <div class="table-responsive table--no-card m-b-50">
                                    <table class="table table-border table-data3 table-hover table-responsive" id="dataTables-example">
                                       <thead>
                                                <tr>
