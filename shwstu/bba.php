      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">STUDENT RECORDS</a>
          </div>
            ...
            <div class="container-fluid">
                ...
                <div class="tab1">
                        <div class="tabs">
                                 ...
                                 <option value="#"><a href="">SELECT DEPARTMENT</a></option>
                                <option value="s1.php"><a href="#tab1">IT</a></option>
                                    ...
                                    <div class="container">
                                        <table class=" table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                <?php  
                                                    include 'conf.php';
                                                    $stmt = $db->prepare("select * from formm");
                                                    $stmt->execute();
                                                    ...
                                                    while ($row = $stmt->fetch()) 
                                                    {
                                                        ...
                                                        if ($cat == "Business Administration") {
                                                            # code...
                                                       
                                                        ?>
                                                        <tr class="odd gradeX">
                                                            <td class="text-center"><img src=../images/<?php echo $row["image"] ?> height=120px width=120px></td>
                                                            <td><?php echo $row['name']." ".$row['fname'] ?></td>
                                                            <td><?php echo $row['rollno'] ?></td>
                                                            <td><?php echo $row['cell'] ?></td>
                                                            <td><?php echo $row['semester']." / ".$row['departmnet'] ?></td>
                                                            <td><?php echo $row['cnic'] ?></td>
                                                            <td><?php echo $row['email'] ?></td>
                                                            <td><?php echo $row['gender'] ?></td>
                                                            
                                                           <td align="center"><a href='edit.php?id=<?php echo $row["id"]; ?>' style='text-decoration:none'><button class="btn btn-primary" style="width: 60px;padding: 5px;margin-top: 15px">Edit</button></a>
     <a href='delete.php?id=<?php echo $row["id"]; ?>' style='text-decoration:none;'><button class="btn btn-primary" style="width: 60px;padding: 5px;margin-top: 15px;">Delete</button></a>
