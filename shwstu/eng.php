                                                ...
                                                <?php  
                                                    ...
                                                    while ($row = $stmt->fetch()) 
                                                    {
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td><a href='edit.php?edit=<?php echo $id ?>' style='text-decoration:none'><button style="width: 100px;padding: 5px;margin-top: 15px">Edit</button></a>
     <a href='delete.php?id=$id' style='text-decoration:none;'><button style="width: 100px;padding: 5px;margin-top: 15px;">Delete</button></a></td>
                                                        </tr>
