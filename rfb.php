      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">ADD DIGITAL Book</a>
          </div>
                                        ...
                                        <table class=" table table-striped table-bordered table-hover table-responsive" id="dataTables-example">
                                            ...
                                            <thead >
                                                <tr>
                                                    ...
                                                    <th align="center">STUDENT REG.NO</th>
                                                    <th align="center">ISBN</th>
                                                    <th align="center">BOOK NAME</th>
                                                    <th align="center">BOOK AUTHOR</th>
                                                    
                                                    <th align="center">ISSUE / DELETE</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php  
                                                    ...
                                                    while ($row = $stmt->fetch()) 
                                                    {
                                                        ...
                                                        <tr class="odd gradeX">
                                                           ...
                                                           <td align="center"><a href='issuebook.php?issue=<?php echo $id ?>' style='text-decoration:none'><button class="btn btn-primary" style="width: 60px;padding: 5px;margin-top: 15px">ISSUE</button></a>
                            
                                <a href='delete.php?del=<?php echo $row['id'] ?>' style='text-decoration:none;'><button class="btn btn-danger" style="width: 125px;padding: 5px;margin-top: 15px;"><i class="fa fa-pencil"></i> discard</button></a>
                            </td>
