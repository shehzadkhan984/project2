...
while($result=mysqli_fetch_assoc($data))
{
    ...
    $author=$result['bauthor'];
    $isbn=$result['bisbn'];
    $studname=$result['stuname'];
    $studroll=$result['sturoll'];
...
<input class="form-control" value="<?php echo $studname; ?>" type="text" name="stuname" id="bookid" required="required" readonly/>
...
<input class="form-control" value="<?php echo $studroll; ?>" type="text" name="sturoll" id="bookid" required="required" readonly/>
...
<label>Book Title<span style="color:red;">*</span></label>
  <input class="form-control" value="<?php echo $bname; ?>" type="text" name="book"  required="required" readonly/>
